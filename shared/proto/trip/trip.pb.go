...
func (x *CreateTripResponse) GetDriverID() string {
	if x != nil {
		return x.DriverID
	}
	return ""
...
func (x *CreateTripResponse) GetStartTime() string {
	if x != nil {
		return x.StartTime
	}
	return ""
...
const file_trip_proto_rawDesc = "" +
	...
	"\bGeometry\x122\n" +
	"\vcoordinates\x18\x02 \x03(\v2\x10.trip.CoordinateR\vcoordinates\"k\n" +
	"\x05Route\x12*\n" +
